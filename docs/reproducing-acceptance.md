...
`×AR`은 ±0.2~0.4를 달고 다닌다.

⚠️ 원인이 단순한 발열 누적은 **아니다**. 한 스윕(130런)의 앞뒤에 AR을 각각 13런 넣어 재보니
18.20 → 18.31 t/s로 **+0.6%**밖에 안 움직였다. 즉 "뒤에 돌수록 느리다"가 아니라, 스윕과 스윕
사이의 무언가에 달려 있다. 실무 지침은 같다:
